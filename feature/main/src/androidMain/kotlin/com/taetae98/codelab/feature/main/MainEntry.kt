...
import com.taetae98.codelab.navigation.compose.datastore.navigateToDataStore
import com.taetae98.codelab.navigation.compose.google.oauth.navigateToGoogleOAuth
...
public fun NavGraphBuilder.mainEntry(navController: NavController) {
    composable(MainEntry.ROUTE) {
        MainRoute(
            ...
            onGoogleOAuth = navController::navigateToGoogleOAuth,
        )
    }
}
